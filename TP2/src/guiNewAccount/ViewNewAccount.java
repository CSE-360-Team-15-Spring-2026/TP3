...
public class ViewNewAccount {
	...
	*/
	...
	// This alert is used should the user enter a username that does not satisfy the FSM requirements
	protected static Alert UsernameError = new Alert(AlertType.INFORMATION);
    ...
    /** The Scene object used for the New Account page. */
	...
	*/
	...
	private ViewNewAccount() {
		...
		// If the username does not satisfy the FSM requirements, this alert dialog will tell the user                                                 
		UsernameError.setTitle("Invalid Username");                           
		UsernameError.setHeaderText("The username does not satisfy the requirements.");                                                              
		UsernameError.setContentText("");  // Set this later with actual error message from UserNameRecognizer                                                
