 ...
 /**
  * The Class PasswordEvaluator.
  */
 public class PasswordEvaluator {
	 
	    /** Default constructor. All fields and methods are static; this class is not directly instantiated. */
	 ...
	 /** The error message generated during password evaluation. */
		public static String passwordErrorMessage = "";		// The error message text
		/** The input password string being evaluated. */
		public static String passwordInput = "";			// The input being processed
		/** The index within the input where the password error was found. */
		...
		private static int currentCharNdx;					// The index of the cur rent character
