...
public class ViewEditReply {
	...
	private static ViewEditReply theView;		// Used to determine if instantiation of the class
												// is needed
	...
	private static Scene theViewEditReplyScene;	// The shared Scene each invocation populates
	...
	/**********
	 * <p> Method: displayEditReply(Stage ps, User user) </p>
	 * 
	 ...
	 * 
	 */
	public static void displayEditReply(Stage ps, User user) {
		...
		if (theView == null) theView = new ViewEditReply();		// Instantiate singleton if needed
	...
	private ViewEditReply() {
		...
		theViewEditReplyScene = new Scene(theRootPane, width, height);	// Create the scene
