...
public class ViewDeleteUser {
	...
	*/
	...
	protected static Button button_AddRole = new Button("Confirm");
	protected static List<String> removeList = new ArrayList<String>();
	
	protected static Label label_SelectRoleToBeAdded = new Label("Are You Sure?");
	...
	/** The Scene object populated by each invocation of this page. */
	...
	*/
	...
	public ViewDeleteUser() {
		...
		/** The Scene object that each invocation of this page populates. */
		...
		button_AddRole.setOnAction((_) -> {
			ControllerDeleteUser.userDeletion();
		});
